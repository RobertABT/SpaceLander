  ...
  if (Serial.available()) {
    ...
    switch (input) {
      ...
      case 'd':
        ...
        //Serial.println("up");
        //stepper_c.step(100);
        stepper_a.step((stepsPerRevolution / 4));
        stepper_b.step((stepsPerRevolution / 4));
        stepper_c.step(-(stepsPerRevolution / 4));
        delay(100);
        stepsa += (stepsPerRevolution / 4);
        stepsb += (stepsPerRevolution / 4);
        stepsc += (stepsPerRevolution / 4);
        Serial.println('down');
        break;
      case 'q':
        delay(50);
